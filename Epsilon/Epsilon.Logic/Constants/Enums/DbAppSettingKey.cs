...
namespace Epsilon.Logic.Constants.Enums
{
    public enum DbAppSettingKey
    {
        ...
        AntiAbuse_PickOutgoingVerification_DisableMaxOutstandingPerUserCheck,
        AntiAbuse_PickOutgoingVerification_GlobalMaxFrequency,
        AntiAbuse_PickOutgoingVerification_MaxFrequencyPerIpAddress,
        AntiAbuse_PickOutgoingVerification_MaxOutstandingPerUser,
        AntiAbuse_PickOutgoingVerification_MaxOutstandingPerUserForNewUser,
