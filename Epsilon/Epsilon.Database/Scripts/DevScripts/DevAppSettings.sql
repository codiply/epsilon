...
(N'OutgoingVerification_Pick_MinDegreesDistanceInAnyDirection', N'0.1'),
...
(N'UserAccountMaintenance_DisableRewardOutgoingVerificationSendersIfNoneUsedAfterCertainPeriod', N'False');
GO
