...
(N'AntiAbuse_GeocodeFailure_MaxFrequencyPerUser', N'4/2H', N'Frequency',
 N'The maximum number of times a user can fail geocoding when adding an address in a certain period of time.'),
(N'AntiAbuse_GeocodeFailure_DisableUserFrequencyCheck', 'False', N'Boolean',
 N'Disables the anti-abuse uer frequency check for geocode failures.'),
(N'AntiAbuse_GeocodeFailure_MaxFrequencyPerIpAddress', N'8/H', N'Frequency',
...
(N'AntiAbuse_GeocodeFailure_DisableIpAddressFrequencyCheck', 'False', N'Boolean',
