...
(N'AntiAbuse_PickOutgoingVerification_MaxOutstandingPerUserConstant', N'4', N'Integer',
     N'The number C of maximum outstanding outgoing verifications for a new user. Generally this number for a user is C + X, where X is the number of verifications used by their recipients.'), 
