...
(N'AntiAbuse_AddAddress_GlobalMaxFrequency', N'1000/D', 'Frequency',
...
(N'AntiAbuse_PickOutgoingVerification_DisableMaxOutstandingPerUserCheck', N'False', N'Boolean',
...
(N'AntiAbuse_PickOutgoingVerification_MaxOutstandingPerUser', N'8', N'Integer',
     N'The number maximum outstanding outgoing verifications for a user without completed outgoing verifications.'), 
(N'AntiAbuse_PickOutgoingVerification_MaxOutstandingPerUserForNewUser', N'4', N'Integer',
     N'The number maximum outstanding outgoing verifications for a user without completed outgoing verifications.'), 
...
(N'GlobalSwitch_DisableAddAddress', N'False', 'Boolean',
     N'Disables completely adding a new address.'),
(N'GlobalSwitch_DisableCreateTenancyDetailsSubmission', N'False', 'Boolean',
     N'Disables completely creating a new tenancy details submission.'),
(N'GlobalSwitch_DisablePickOutgoingVerification', N'False', 'Boolean',
     N'Disables completely creating a new outgoing verification.'),
(N'GlobalSwitch_DisableRegister', N'False', 'Boolean',
