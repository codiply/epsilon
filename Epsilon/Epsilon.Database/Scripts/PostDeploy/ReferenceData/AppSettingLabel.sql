...
(N'anti-abuse', N'AntiAbuse_AddAddress_DisableGeoipCheck'),
...
(N'anti-abuse', N'AntiAbuse_CreateTenancyDetailsSubmission_DisableGeoipCheck'),
...
(N'anti-abuse', N'AntiAbuse_PickOutgoingVerification_DisableGeoipCheck'),
...
(N'anti-abuse-add-address', N'AntiAbuse_AddAddress_DisableGeoipCheck'),
...
(N'anti-abuse-create-tenancy-details-submission', N'AntiAbuse_CreateTenancyDetailsSubmission_DisableGeoipCheck'),
...
(N'anti-abuse-pick-outgoing-verification', N'AntiAbuse_PickOutgoingVerification_DisableGeoipCheck'),
...
(N'anti-abuse-switch', N'AntiAbuse_AddAddress_DisableGeoipCheck'),
...
(N'anti-abuse-switch', N'AntiAbuse_CreateTenancyDetailsSubmission_DisableGeoipCheck'),
...
(N'anti-abuse-switch', N'AntiAbuse_PickOutgoingVerification_DisableGeoipCheck'),
...
-- geoip-info
(N'geoip-info', N'AntiAbuse_AddAddress_DisableGeoipCheck'),
...
(N'global-switch', N'GlobalSwitch_DisableUseOfGeoipInformation'),
-- max-frequency
...
(N'period', N'OutgoingVerification_RewardSendersIfNoneUsed_AfterPeriodInDays'),
...
(N'switch', N'AntiAbuse_AddAddress_DisableGeoipCheck'),
...
(N'switch', N'AntiAbuse_CreateTenancyDetailsSubmission_DisableGeoipCheck'),
...
(N'switch', N'AntiAbuse_PickOutgoingVerification_DisableGeoipCheck'),
