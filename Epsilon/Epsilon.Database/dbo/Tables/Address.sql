...
GO
CREATE NONCLUSTERED INDEX [IX_Address_CreatedOn]
    ON [dbo].[Address]([CreatedOn] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Address_DistinctAddressCode]
    ON [dbo].[Address]([DistinctAddressCode] ASC);
