    ...
    { 
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? ManageResources.ManageMessage_ChangePasswordSuccess
                : message == ManageMessageId.SetPasswordSuccess ? ManageResources.ManageMessage_SetPasswordSuccess
                //: message == ManageMessageId.SetTwoFactorSuccess ? "Your two-factor authentication provider has been set."
                : message == ManageMessageId.Error ?  ManageResources.ManageMessage_Error
